"""The player details and instructions component V2.
Fixed spaces in the name being considered an error."""
...
def player_details():
    ...
    def confirm():
        ...
        # Splits the name given into different parts if there is a space.
        # If these parts aren't all letters of the alphabet, display error msg
